...
namespace Bennington.ContentTree.Providers.ContentNodeProvider
{
    ...
    public class SubActionOnlyVisibleDuringModifyAction : ActionSubMenuItem
    {
        ...
        public SubActionOnlyVisibleDuringModifyAction(string name, string actionName, string controllerName)
        ...
        public SubActionOnlyVisibleDuringModifyAction(string name, string actionName, string controllerName, object routeValues)
